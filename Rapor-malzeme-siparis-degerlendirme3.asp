        ...
        <div class="container-fluid" style="margin-top:80px"> 
            ...
            <div class="container-fluid p-4"> <h3></h3>                
                <form class="form-horizontal" method="POST" action="?doo=list">
                    <div class="container-fluid p-4"><h4>Malzeme Sipariş Değerlendirme <div class="badge badge-pill bg-danger">RAKAMLARDAN EMİN DEĞİLİM KONTROL LAZIM</div></h4>         
...
Netsis_SQL = Netsis_SQL + "      WHERE A.SUBE_KODU='1' AND (isnull(A.[STHAR_GCMIK],0) - isnull(A.[FIRMA_DOVTUT] ,0) )>0   "
...
Netsis_SQL = Netsis_SQL + "  	PIVOT (sum(QTY) FOR stst IN (Stok,MusteriSip,TedarikSip,Ihtiyac)) AS P                        "
