...
if instr(UserLevel,"m") then 'needed level'   
    ...
    <div class="container-fluid" style="margin-top:80px;"> 
        ...
        <form class="form-horizontal d-print-none" method="POST" action="?doo=list">
            <div class="container-fluid p-4"> <h3>İşemri bul</h3>
                <div class="input-group">
                    <textarea class="form-control z-depth-1" name="search_is_emri" rows="3" placeholder="Madde Kodları yada İşemri No"><%=str%></textarea>
                ...
                <table class="table table-sm table-striped table-hover align-middle"  id="tblData"> 
                    ...
                    for each xisemri in a
                        ' SQL
                            ...
                            Netsis_SQL=Netsis_SQL+" WHERE A.STOK_KODU LIKE '"&xisemri&"' OR A.ISEMRINO LIKE '"&xisemri&"'  ORDER BY A.[STOK_KODU], TARIH "
                        ' SQL ende                        
